...
function EditQuiz(props) {
	...
	const handleDeleteQuestion = async () => {
		let token = localStorage.getItem("authToken");
		let url = `${backend}/question/${updateId}`;
	...
	const handleQuestionUpdate = async () => {
		...
		let token = localStorage.getItem("authToken");
		let url = `${backend}/question/update/${updateId}`;
	...
	const isOwnerOfQuiz = async () => {
		let token = localStorage.getItem("authToken");
		let url = `${backend}/quiz/checkAdmin/${quizId}`;
	...
	const getQuizDetails = async () => {
		...
		url = `${backend}/question/all/${quizId}`;
		...
		url = `${backend}/admin/allStudentsQuizResult/${quizId}`;
